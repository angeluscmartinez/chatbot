...
# Generate Questions Button (for faster manual triggering)
with st.sidebar:
    if st.button("🔄 Generate New Questions", key="generate_questions_btn"):
...
# Sidebar Configuration (Upload Widget & Clear Chat)
# Sidebar Configuration (Upload Widget & Clear Chat)
with st.sidebar:
